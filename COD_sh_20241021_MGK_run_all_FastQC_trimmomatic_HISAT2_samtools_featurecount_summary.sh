...
SUMMARY_FILE="results/read_counts_summary.csv"  # Define the summary file
THREADS=40
...
for FILE in $RAW_READS_DIR/*_1.fq.gz; do
    ...
    featureCounts -T $THREADS -p -a $GTF_FILE -o ${COUNTS_DIR}/${BASENAME}_counts.txt ${FILTERED_DIR}/${BASENAME}_sorted.bam
